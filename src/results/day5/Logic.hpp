...
namespace AOC2022::results::day5
{
    class Logic
    {
        public:
            ...
            void executeInstructionsInOrder(std::list<std::shared_ptr<Instruction>> instructions);
            void executeInstructionInOrder(std::shared_ptr<Instruction> instruction);
        ...
        private:
            ...
            std::string getItemsFromStackInSameOrder(int stackNum, int noItems);
